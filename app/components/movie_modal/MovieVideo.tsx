  ...
  return (
    <div className="flex justify-start items-center w-screen h-auto">
      <div className="flex relative top-0 left-0 w-full h-[80vw] md:h-[75vh] lg:h-[110vh]">
        ...
        />
        <div className="absolute w-full bottom-0 left-0 bg-none -z-10 shadow-[0_15px_30px_70px_rgba(0,0,0,1)] shadow-[#141414] transform rotate-180">
        </div>
      </div>

      <div className="absolute w-[70%] lg:w-[40%] pl-5 xl:pl-10 mt-[7vw] space-y-1 lg:space-y-4">

  ...
  return (
    <ScrollingElementSSR>
      <div className="relative flex w-screen justify-between items-center px-2 pt-5 pb-2 sm:p-5">
        <div className="flex">
          <Link href="/home" prefetch={false} className="relative flex items-center h-[5vw] md:h-[1.7vw] w-[8vw] sm:w-[11vw] min-w-[5rem]">
            <Image__Logo />
          </Link>
        ...
        <div className="flex items-center lg:space-x-5 space-x-0 pr-5 sm:pr-10">
          ...
          <div className="lg:flex hidden cursor-pointer">Kids</div>

...
export default function AuthFooter() {
  ...
  const marginFooter = pathname === "/home" ? "" : pathname === "/home/new" ? "pt-[36rem]" : "pt-[30rem]"
  
  return (
    <div className={`${marginFooter} flex flex-col max-w-[980px] mx-auto mb-0 px-[4%] items-start`}>
      ...
      <ul 
        className="grid max-[350px]:grid-cols-1 grid-cols-2 md:grid-cols-4 *:text-grayColor_700 *:text-[13px] *:pr-10 *:mb-3 mb-3 *:cursor-pointer"
      >
        {links.map((link)=> (
